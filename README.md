...
- Clone the github repository
  ```shell
  $ git clone https://github.com/axwrx/spotter_case_study.git
  ```
- Open
  the [notebook](https://github.com/axwrx/spotter_case_study/blob/main/semantic-spotter-langchain-notebook.ipynb)
